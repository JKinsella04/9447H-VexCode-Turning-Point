...
void BallAuton() {
    ...
    fourWheelDrive(75, 75);
    DriveLeft.resetRotation();
    DriveRight.resetRotation();
    DriveLefttwo.resetRotation();
    DriveRighttwo.resetRotation();
    DriveLeft.startRotateTo(340,vex::rotationUnits::deg,60,vex::velocityUnits::pct);
    DriveLefttwo.startRotateTo(340,vex::rotationUnits::deg,60,vex::velocityUnits::pct);
    DriveRight.startRotateTo(-340,rotationUnits::deg,60,velocityUnits::pct);
    DriveRighttwo.rotateTo(-340,rotationUnits::deg,60,velocityUnits::pct);
    fourWheelDrive(500, 75);
    DriveLeft.resetRotation();
    DriveRight.resetRotation();
    DriveLefttwo.resetRotation();
    DriveRighttwo.resetRotation();
    DriveLeft.startRotateTo(0,vex::rotationUnits::deg,50,vex::velocityUnits::pct);
    DriveLefttwo.startRotateTo(0,vex::rotationUnits::deg,50,vex::velocityUnits::pct);
    DriveRight.startRotateTo(230,rotationUnits::deg,50,velocityUnits::pct);
    DriveRighttwo.rotateTo(230,rotationUnits::deg,50,velocityUnits::pct);
    ...
    */
    ...
    DriveLefttwo.resetRotation();
    DriveRighttwo.resetRotation();
    DriveLeft.startRotateTo(110,vex::rotationUnits::deg,35,vex::velocityUnits::pct);
    DriveLefttwo.startRotateTo(10,vex::rotationUnits::deg,35,vex::velocityUnits::pct);
    DriveRight.startRotateTo(-10,rotationUnits::deg,35,velocityUnits::pct);
    DriveRighttwo.rotateTo(-10,rotationUnits::deg,35,velocityUnits::pct);
    shootBall();
        task::sleep(1500);
    BallOutput.stop();
    BallOutputtwo.stop();
    ...
    DriveLefttwo.resetRotation();
    DriveRighttwo.resetRotation();
    DriveLeft.startRotateTo(35,vex::rotationUnits::deg,35,vex::velocityUnits::pct);
    DriveLefttwo.startRotateTo(35,vex::rotationUnits::deg,35,vex::velocityUnits::pct);
    DriveRight.startRotateTo(-35,rotationUnits::deg,35,velocityUnits::pct);
    DriveRighttwo.rotateTo(-35,rotationUnits::deg,35,velocityUnits::pct);
